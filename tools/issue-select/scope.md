...
I have used Python for basic scripting, Git and VS Code for coursework, 
and JavaScript in CodePath web development. My computer engineering projects 
include ESP32 hardware, data analysis, and security features. I am especially
interested in cybersecurity and engineering issues. I want to improve my 
debugging and testing skills through a small change with a clear result that 
I can reproduce on my computer.